...
- Check the [`README`](https://github.com/igorskyflyer/npm-scrollend-polyfill/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-scrollend-polyfill/issues) to see if your question has already been answered.
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-scrollend-polyfill/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-scrollend-polyfill/blob/main/CONTRIBUTING.md) for guidelines.
